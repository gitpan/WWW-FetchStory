...
eval { $v .= pmver('EBook::EPUB','any version') };
eval { $v .= pmver('Encode','any version') };
eval { $v .= pmver('Encode::ZapCP1252','any version') };
...
eval { $v .= pmver('HTML::Tidy::libXML','any version') };
eval { $v .= pmver('HTTP::Cookies','any version') };
eval { $v .= pmver('HTTP::Cookies::Mozilla','any version') };
...
eval { $v .= pmver('WWW::Mechanize::Sleepy','any version') };
